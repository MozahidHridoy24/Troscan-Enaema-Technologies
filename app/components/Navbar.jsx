...
export default function Navbar() {
  ...
  return (
    <nav className="fixed md:w-7/12 mx-auto left-0 right-0 z-50 px-2 py-2 w-11/12 mt-2 flex flex-col items-center">
      {/* Wrapper to prevent layout shift */}
      <div className="w-full max-w-5xl">
        <motion.div
          initial={{ opacity: 0, y: -20 }} // small, smooth entrance
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-md shadow-2xl px-2 py-1"
        >
          {/* Top bar */}
          <div className="flex justify-between items-center">
            {/* Logo */}
            <div className="text-xl px-2 font-bold text-[#7a3f2e] tracking-wide">
              Troscán
            </div>
            ...
            <div className="flex items-center">
              ...
              <button className="bg-[#7a3f2e] text-white font-medium px-5 py-2.5 rounded-md hover:bg-amber-800 transition hidden md:block">
                Contact us
              </button>
